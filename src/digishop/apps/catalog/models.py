...
from digishop.apps.catalog.managers import CategoryQuerySet
from digishop.libs.dbs.fields import UpperCaseCharField
from digishop.libs.dbs.models import AuditableModel
...
class Product(AuditableModel):
    ...
    recommended_products = models.ManyToManyField('Product', through='ProductRecommendations', blank=True)
    catagories = models.ManyToManyField(Category, related_name='categories')
...
class ProductImage(models.Model):
    ...
    image = models.ForeignKey('media.Image',models.PROTECT)
